...
- **INTENT:**  AVIS DISPATCH LICENSE RETURN Readme.md SEED SENTINEL_SCROLL.md SOURCE SPEC avis_reader.sh exec index.dhtml scroll_generator.sh sentinel_fluid.pl sitemap.avis sitemap.sh AVIS_GUIDE: This function performs the "Cyborg Rip" by re-linking
