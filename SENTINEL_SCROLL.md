...
- **Intel:** Navigator is the central onboarding hub for the Cyborg‑Live ecosystem. It teaches new users how to join  and walks them through using clear, step‑by‑step instructions. Navigator is where Cyborg‑Live EX/MD live. It’s the starting point , workflow for  connecting accounts, and publishing Navigational files across the entire constellation.
